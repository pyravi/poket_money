...
urlpatterns = [
    ...
    path(
        "delete-income-source/<int:id>/",
        views.delete_income_source,
    ...
    path(
        "income-summary/",
        TemplateView.as_view(template_name="income_app/income_summary.html"),
        name="income_summary",
    ),
    path(
        "download-excel/<str:filter_by>",
        views.download_as_excel,
        name="income_download_as_excel",
    ),
    path(
        "download-csv/<str:filter_by>",
        views.download_as_csv,
        name="income_download_as_csv",
    ),
    ...
    path(
        "income-import-from-excel", views.upload_excel, name="income_import_from_excel"
    ),
]
