...
class Stock(models.Model):
    ...
    isin =  models.CharField(max_length=15,help_text=" International Securities Identification Number",blank=True)
    created_at = models.DateTimeField(default=localtime)
...
class Goal(models.Model):
    ...
    last_update= models.DateTimeField(_("Till Date"), auto_now=False, auto_now_add=False)
